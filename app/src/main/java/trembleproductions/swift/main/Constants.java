package trembleproductions.swift.main;
...
public class Constants {
	...
	public static final String STREET_PATH = "src/data/streetimages"; // street images path
	...
	// array sizes
	public static final int SCREEN_TEXT_SIZE = 30; // NOTE: this value has to be exactly equal to the number of Strings on screen
}
